...
class Secure_Shield_Cloudflare {
    ...
    public function register_settings() {
        ...
        register_setting( 'secure_shield', 'secure_shield_cloudflare_token', 'sanitize_text_field' );
    ...
    public function block_ip( $ip ) {
        ...
        $token = get_option( 'secure_shield_cloudflare_token' );
            ...
            array(
                ...
                'body'    => wp_json_encode(
                    array(
                        ...
                        'notes'   => 'Secure Shield automated block',
                    )
                ),
                'timeout' => 15,
            )
