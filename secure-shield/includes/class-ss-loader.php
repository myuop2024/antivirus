<?php
/**
 * Main loader for BISON Security Suite.
 *
...
class Secure_Shield_Loader {
    ...
    protected function load_dependencies() {
        ...
        require_once SECURE_SHIELD_PATH . 'includes/class-ss-ai.php';
    ...
    protected function register_services() {
        ...
        $this->services['ai']          = new Secure_Shield_AI_Assistant( $this->services['logger'], $this->services['settings'] );
        $this->services['remediator']  = new Secure_Shield_Remediator( $this->services['logger'], $this->services['settings'], $this->services['ai'] );
        ...
        $this->services['cloudflare']  = new Secure_Shield_Cloudflare( $this->services['logger'], $this->services['settings'] );
        ...
        $this->services['rest']       = new Secure_Shield_REST( $this->services['scanner'], $this->services['logger'], $this->services['firewall'] );
    ...
    public function load_textdomain() {
        load_plugin_textdomain( SECURE_SHIELD_TEXT_DOMAIN, false, dirname( plugin_basename( SECURE_SHIELD_PATH . 'secure-shield.php' ) ) . '/languages' );
    }
}
