...
class Secure_Shield_Scheduler {
    ...
    public function register_custom_schedules( $schedules ) {
        $schedules['secure_shield_6h'] = array(
            ...
            'display'  => __( 'Every 6 Hours (Secure Shield)', 'secure-shield' ),
        );
        return $schedules;
    }
    ...
    public function execute_daily_scan() {
        ...
        do_action( 'secure_shield/log', __( 'Scheduled deep scan executed.', 'secure-shield' ) );
    }
    ...
    public function execute_hourly_tasks() {
        ...
        do_action( 'secure_shield/log', __( 'Hourly maintenance completed.', 'secure-shield' ), 'info' );
    }
}
